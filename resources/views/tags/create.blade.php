                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center gap-4">
                                    <input type="color" id="cor" name="cor" value="{{ old('cor', '#3B82F6') }}" class="h-10 w-20 rounded border-gray-300 dark:border-gray-700 cursor-pointer" required>
                                    <x-text-input type="text" id="cor_hex" class="block w-full" value="{{ old('cor', '#3B82F6') }}" pattern="^#[0-9A-Fa-f]{6}$" placeholder="#3B82F6" />
                                </div>
                            ...
                            <div>
                                ...
                                <select id="tipo" name="tipo" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    <option value="ambos" {{ old('tipo') == 'ambos' ? 'selected' : '' }}>Ambos (Prestador e Condomínio)</option>
                                    <option value="prestador" {{ old('tipo') == 'prestador' ? 'selected' : '' }}>Apenas Prestador</option>
                                    <option value="condominio" {{ old('tipo') == 'condominio' ? 'selected' : '' }}>Apenas Condomínio</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="ordem" class="block mt-1 w-full" type="number" name="ordem" :value="old('ordem', 0)" min="0" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="descricao" name="descricao" rows="3" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('descricao') }}</textarea>
