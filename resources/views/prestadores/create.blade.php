                    ...
                    <form method="POST" action="{{ route('prestadores.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="nome_razao_social" class="block mt-1 w-full" type="text" name="nome_razao_social" :value="old('nome_razao_social')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="cpf_cnpj" class="block mt-1 w-full" type="text" name="cpf_cnpj" :value="old('cpf_cnpj')" placeholder="Digite o CPF ou CNPJ" />
