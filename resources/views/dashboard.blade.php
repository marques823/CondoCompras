                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Condominio::where('empresa_id', auth()->user()->empresa_id)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Prestador::where('empresa_id', auth()->user()->empresa_id)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Demanda::where('empresa_id', auth()->user()->empresa_id)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Orcamento::whereHas('demanda', function($q) { $q->where('empresa_id', auth()->user()->empresa_id); })->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
