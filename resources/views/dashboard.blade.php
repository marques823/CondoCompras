<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Administradoras</p>
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Administradora::count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
                <!-- Dashboard para Administradoras -->
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Condominio::where('administradora_id', auth()->user()->administradora_id)->count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Prestador::where('administradora_id', auth()->user()->administradora_id)->count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Demanda::where('administradora_id', auth()->user()->administradora_id)->count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ \App\Models\Orcamento::whereHas('demanda', function($q) { $q->where('administradora_id', auth()->user()->administradora_id); })->count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <a href="{{ route('administradoras.create') }}" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                <svg class="h-8 w-8 text-blue-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                </svg>
                                <div>
                                    <p class="font-medium">Nova Administradora</p>
                                    <p class="text-sm text-gray-500">Cadastrar administradora</p>
                                </div>
                            </a>
                            <a href="{{ route('users.create') }}" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Criar usuário</p>
                                </div>
                            </a>
                        </div>
                    </div>
