                    ...
                    <form method="POST" action="{{ route('demandas.update', $demanda) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <input type="hidden" id="categoria_servico_id" name="categoria_servico_id" value="{{ old('categoria_servico_id', $demanda->categoria_servico_id) }}">
                                    <input type="text" 
                                           id="tipo_servico" 
                                           class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" 
                                           placeholder="Digite ou escolha o tipo de serviço (ex: CFTV, Elétrica, Pintura...)"
                                           autocomplete="off"
                                           value="{{ old('tipo_servico', $demanda->categoriaServico->nome ?? '') }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="prazo_limite" class="block mt-1 w-full" type="date" name="prazo_limite" :value="old('prazo_limite', $demanda->prazo_limite?->format('Y-m-d'))" />
