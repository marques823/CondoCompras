        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="{{ route('prestadores.index') }}" class="text-green-100 hover:text-white text-sm">Ver todos</a>
                    </div>
                    <p class="text-green-100 text-sm mb-1">Prestadores</p>
                    <p class="text-4xl font-bold">{{ $totalPrestadores }}</p>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('prestadores.create') }}" class="flex items-center p-4 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-2 border-green-300 dark:border-green-700 rounded-lg hover:from-green-100 hover:to-green-200 dark:hover:from-green-800/30 dark:hover:to-green-700/30 transition">
                        <svg class="h-10 w-10 text-green-600 dark:text-green-400 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        <div>
                            <p class="font-bold text-gray-900 dark:text-gray-100">Novo Prestador</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Cadastrar prestador</p>
                        </div>
                    </a>
                    <a href="{{ route('condominios.create') }}" class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-2 border-blue-300 dark:border-blue-700 rounded-lg hover:from-blue-100 hover:to-blue-200 dark:hover:from-blue-800/30 dark:hover:to-blue-700/30 transition">
                        <svg class="h-10 w-10 text-blue-600 dark:text-blue-400 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        <div>
                            <p class="font-bold text-gray-900 dark:text-gray-100">Novo Condomínio</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Cadastrar condomínio</p>
                        </div>
                    </a>
                </div>
            </div>
